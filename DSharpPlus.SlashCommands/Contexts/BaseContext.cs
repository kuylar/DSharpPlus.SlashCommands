...
namespace DSharpPlus.SlashCommands
{
	...
	public class BaseContext
	{
		...
		///         potential to take more than 3 seconds, use <see cref="DeferAsync" /> at the start, and edit the response later.
		///     </para>
		/// </summary>
		...
		/// <inheritdoc
		///     cref="CreateResponseAsync(DSharpPlus.InteractionResponseType,DSharpPlus.Entities.DiscordInteractionResponseBuilder)" />
		...
		public Task CreateResponseAsync(string content, DiscordEmbed embed, bool ephemeral = false)
			=> CreateResponseAsync(new DiscordInteractionResponseBuilder().WithContent(content).AddEmbed(embed)
